  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-900 border-t border-primary/10 flex justify-around py-2 z-50">
      ...
      >
        ...
        <span className="text-[10px] font-medium">Trang chu</span>
      </button>
      <button
        type="button"
      ...
      >
        ...
        <span className="text-[10px] font-medium">Quet ma</span>
      </button>
      <button
        type="button"
